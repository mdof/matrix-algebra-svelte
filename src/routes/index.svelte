...
<div class="block">
	...
	<h2>Vector = {vec}</h2>
	<Matrix bind:matrix_vec={vec} />
</div>
<div class="block">
	<h2 class="font-bold">Full matrix , flow column (default)</h2>
	<Matrix matrix_vec={[1, 2, 3, 4]} />
	<h2 class="font-bold">Full matrix , flow row</h2>
	<Matrix matrix_vec={[1, 2, 3, 4]} flow_order="row" />
	<h2 class="font-bold">Not squared</h2>
	<Matrix bind:matrix_vec={not_squared} />
</div>
...
<div class="block">
	...
	<Matrix bind:matrix_vec={vec_modified_by_dim} />
</div>
